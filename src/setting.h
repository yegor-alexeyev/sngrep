...
#endif
    SETTING_AMQP_ADDRESS,
    SETTING_AMQP_PORT,
    SETTING_AMQP_USERNAME,
    SETTING_AMQP_PASSWORD,
    SETTING_AMQP_EXCHANGE,
    SETTING_AMQP_ROUTING_KEY,
    SETTING_CLASS4_ADDRESS,
    SETTING_CLASS4_PORT,
    SETTING_CLASS4_FIELDS,
    SETTING_CLASS4_INGRESS_FIELDS,
    SETTING_CLASS4_EGRESS_FIELDS,
    SETTING_SERVER_WEBSOCKET_ADDRESS,
    SETTING_SERVER_WEBSOCKET_PORT,
    SETTING_SERVER_AUTH_SERVER,
    SETTING_SERVER_UNCLASSIFIED_LIFETIME,
    SETTING_SERVER_CLASSIFIED_LIFETIME,
    SETTING_SERVER_PERIODIC_UPDATE_INTERVAL_MILLISECONDS,
